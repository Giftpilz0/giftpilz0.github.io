...
Configure automatic package upgrades with dnf-automatic.
...
| `autoupgrade_reboot`          | bool           | true, false                           | `{{ false if ansible_facts['os_family'] == 'Debian' else 'never' }}` | reboot behavior after upgrades                                    |
